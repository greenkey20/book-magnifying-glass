const storyData = [
  {
    ...
    icon: "🏙️",
    imageUrl:
      "https://github.com/greenkey20/book-magnifying-glass/blob/main/images/02%20IMG_1187.png?raw=true",
...
function updateContent(index) {
  ...
  if (story.imageUrl) {
    ...
    img.className =
      "w-full h-auto max-h-[300px] object-cover rounded-lg shadow-md mx-auto block"; // 반응형 이미지 스타일링
